...
//    $('#tableContainer').jqotesubtpl("templates/recordings-table.tpl", makeRenderData(data));
 ...
 //   var pageCount = Math.ceil(data.workflows.totalCount / ocRecordings.Configuration.pageSize);
  ...
  this.makeActions = function(recording, actions) {
      ...
      if (state === 'Upcoming'){
          links.push('<a title="Edit this recording" href="../schedule/index.html?sid='+ seriesID + '&upload=' + uploadSetting +  '&eventId=' + id + '&edit=true"><img src="/ltitools/uct/shared/img/icons/edit.png"></img></a>');
      }else{
          links.push('<span class="greyed_out" title="Cannot be edited"><img src="/ltitools/uct/shared/img/icons/edit.png"></img></span>');
      }

      if (state === 'Upcoming'){
          //TO DO : links.push('<a title="Remove this Recording from UI only" href="javascript:ocRecordings.stopWorkflow(\'' + id + '\')">Ignore</a>');
          links.push('<a title="Delete this recording" href="javascript:ocRecordings.removeRecording(\'' + id + '\')"><img src="/ltitools/uct/shared/img/icons/delete.png"></img></a>');
      }else{
          links.push('<span class="greyed_out" title="Cannot be deleted"><img src="/ltitools/uct/shared/img/icons/delete.png"></img></span>');
      }
      return links.join(' \n');
  }
